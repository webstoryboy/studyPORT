(function(){
    ...
    $(window).scroll(function(){
        ...
        // 장단점 등장씬
        if(scroll > $(".about-cont2").offset().top - $(window).height()/2){
        ...
        if(scroll > $(".about-cont3").offset().top - $(window).height()/2){
        ...
        if(scroll > $(".about-cont4").offset().top - $(window).height()/2){
            gsap.to(".about-cont4 .profile-img", {duration: 2, scale: 1, rotation:0, opacity:1 ,ease: "expo.out"})
            let about3 = gsap.timeline();
            about3.to(".about-cont4 .profile-text-wrap h3 span", {opacity:1, y:0, stagger:0.1, ease: "back.inOut(3)"})
        ...
        if(scroll > $('#port2').offset().top + $(window).height()/2 && scroll < $('#port2 .publi-box:last-child').offset().top + $(window).height() ) {
        ...
        if(scroll > $('#port2 .publi-title').offset().top - $(window).height() * 1/2){
        ...
        if(scroll > $('.publi-box').eq(0).offset().top - $(window).height() / 2) {
            let port2Box1 = gsap.timeline();
            port2Box1.to("#port2 .publi-box:nth-child(2) .publi-text-wrap h3 span", {opacity:1, y:0, stagger:0.1, ease: "back.inOut(2)"})
       ...
       if(scroll > $('.publi-box').eq(1).offset().top - $(window).height() / 2) {
            let port2Box2 = gsap.timeline();
            port2Box2.to("#port2 .publi-box:nth-child(3) .publi-text-wrap h3 span", {opacity:1, y:0, stagger:0.1, ease: "back.inOut(2)"})
       ...
       if(scroll > $('.publi-box').eq(2).offset().top - $(window).height() / 2) {
            let port2Box2 = gsap.timeline();
            port2Box2.to("#port2 .publi-box:nth-child(4) .publi-text-wrap h3 span", {opacity:1, y:0, stagger:0.1, ease: "back.inOut(2)"})
       ...
       if(scroll > $('.publi-box').eq(3).offset().top - $(window).height() / 2) {
            let port2Box2 = gsap.timeline();
            port2Box2.to("#port2 .publi-box:nth-child(5) .publi-text-wrap h3 span", {opacity:1, y:0, stagger:0.1, ease: "back.inOut(2)"})
       ...
       function viewed(number){
            if(scroll > $('.publi-box').eq(number).offset().top - $(window).height() / 2){
       ...
       if(scroll > $('#port2 .publi-box:last-child').offset().top + $(window).height() &&  scroll < $("#port4").offset().top - 1){
        ...
        //애니메이션
        if(scroll > $('#port4 .ani-wrap').offset().top - $(window).height()/2){
            let port4Ani = gsap.timeline();
            port4Ani.to("#port4 .ani-title h2 span span", {y:0, opacity:1, stagger:0.1, ease: "back.inOut(2)"})
        ...
        if(scroll > $('#port4 .ani-wrap').offset().top + $(window).height()* 0.05){
        ...
        //스크립트
        if(scroll > $('#port4 .script-wrap').offset().top - $(window).height()/2){
            let port4Ani = gsap.timeline();
            port4Ani.to("#port4 .script-title h2 span span", {y:0, opacity:1, stagger:0.1, ease: "back.inOut(2)"})
        ...
        if(scroll > $('#port4 .script-wrap').offset().top + $(window).height()* 0.05){
