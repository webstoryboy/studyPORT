function _getClosest(item, array, getDiff) {
    ...
    constructor(options = {}) {
        ...
        this.opts = {
        el: options.el || '.js-slider__inner',
    ...
    run() {
        ...
        // this.sliderInner.style.transform = `translate3d(${this.lastX / 3}px, 0, 0) skewX(${velo * this.opts.velocity}deg)`;
    ...
    // clone() {
    //     this.slidesClone = this.slides.firstElementChild.cloneNode(true);
    //     this.slides.appendChild(this.slidesCloneNode);
    // }
