...
let loops2 = gsap.utils.toArray('.site__title').map((line, i) => {
    const links2 = line.querySelectorAll(".site__cont.desc1");
...
let loops3 = gsap.utils.toArray('.site__title').map((line, i) => {
    const links3 = line.querySelectorAll(".site__cont.desc2");
...
let loops4 = gsap.utils.toArray('.site__title').map((line, i) => {
    const links4 = line.querySelectorAll(".site__cont.desc3");
...
function horizontalLoop(items, config) {
    ...
    gsap.set(items, { // convert "x" to "xPercent" to make things responsive, and populate the widths/xPercents Arrays to make lookups faster.
        xPercent: (i, el) => {
            ...
            xPercents[i] = snap(parseFloat(gsap.getProperty(el, "x", "px")) / w * 10 + gsap.getProperty(el, "xPercent"));
            return xPercents[i];
        }
    });
    gsap.set(items, {
    ...
    for (i = 0; i < length; i++) {
        ...
        tl.to(item, {
            ...
            .fromTo(item, {
                xPercent: snap((curX - distanceToLoop + totalWidth) / widths[i] * 10)
            }, {
