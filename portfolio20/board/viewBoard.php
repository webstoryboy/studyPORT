                    ...
                    <div class="listTable">
                        <table class="table">
                            ...
                            <?php if (
                                ...
                                $sql = "SELECT b.boardTitle, b.boardContent, m.youNickName, b.regTime FROM port03Board b JOIN port03Member m ON (b.memberID = m.memberID) WHERE b.boardID = {$boardID}";
